...
import { Directive, Input, EventEmitter, SecurityContext, Component, Optional, Inject, Output, HostListener, NgModule } from '@angular/core';
...
export { ImageViewerComponent, ImageViewerModule };
